...
if __name__=='__main__': 
    ...
    #     for j in range(9):
    #         t[j]=t[j]-s[j]
    #     print("a(g):%10.3f %10.3f %10.3f w(deg/s):%10.3f %10.3f %10.3f Angle(deg):%10.3f %10.3f %10.3f"%t)
    # 
    port='/dev/ttyUSB0'
    baud = 115200
    #baud = int(input('please input baudrate(115200 for JY61 or 9600 for JY901):'))
    ...
    print(ser.is_open)
    datahex = ser.read(33)
    s = list(DueData(datahex))
    for i in range(30):
      datahex = ser.read(33)
      t = list(DueData(datahex))
#      print(s)
#      print(t)
      for j in range(9):
        s[j]=(s[j]+t[j])/2
    ...
    while(1):
      ...
      for j in range(9):
        t[j]=t[j]-s[j]
      print("a(g):%10.3f %10.3f %10.3f w(deg/s):%10.3f %10.3f %10.3f Angle(deg):%10.3f %10.3f %10.3f"%tuple(t))        